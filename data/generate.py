...
for size in sizes:
    ...
    np.savetxt(f'benchmark/random_array_{size:08d}.txt',
               np.insert(random_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/increasing_array_{size:08d}.txt',
               np.insert(increasing_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/decreasing_array_{size:08d}.txt',
               np.insert(decreasing_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/constant_array_{size:08d}.txt',
               np.insert(constant_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/a_shaped_array_{size:08d}.txt',
               np.insert(a_shaped_array, 0, size), fmt='%d')
